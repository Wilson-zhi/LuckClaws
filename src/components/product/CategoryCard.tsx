...
export function CategoryCard({ name, href, image, alt }: CategoryCardProps) {
  return (
    ...
    >
      ...
      <div className="absolute left-4 top-4 rounded-full border border-white/30 bg-white/85 px-3 py-1 text-[11px] font-bold uppercase tracking-wide text-primary shadow-soft">
        Routine path
      </div>
